...
class GetVirtualWanResult:
    ...
    def allow_branch_to_branch_traffic(self) -> Optional[builtins.bool]:
        """
    ...
    def allow_vnet_to_vnet_traffic(self) -> Optional[builtins.bool]:
        """
    ...
    def disable_vpn_encryption(self) -> Optional[builtins.bool]:
        """
...
def get_virtual_wan(resource_group_name: Optional[builtins.str] = None,
    ...
    :param builtins.str virtual_wan_name: The name of the VirtualWAN being retrieved.
    """
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['virtualWANName'] = virtual_wan_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getVirtualWan', __args__, opts=opts, typ=GetVirtualWanResult, package_ref=_utilities.get_package()).value
...
def get_virtual_wan_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getVirtualWan', __args__, opts=opts, typ=GetVirtualWanResult, package_ref=_utilities.get_package())
