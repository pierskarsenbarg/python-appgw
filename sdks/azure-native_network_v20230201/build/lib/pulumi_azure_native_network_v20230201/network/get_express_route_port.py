...
class GetExpressRoutePortResult:
    ...
    def bandwidth_in_gbps(self) -> Optional[builtins.int]:
        """
    ...
    def peering_location(self) -> Optional[builtins.str]:
        """
    ...
    def provisioned_bandwidth_in_gbps(self) -> builtins.float:
        """
...
def get_express_route_port(express_route_port_name: Optional[builtins.str] = None,
    ...
    :param builtins.str express_route_port_name: The name of ExpressRoutePort.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getExpressRoutePort', __args__, opts=opts, typ=GetExpressRoutePortResult, package_ref=_utilities.get_package()).value
...
def get_express_route_port_output(express_route_port_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getExpressRoutePort', __args__, opts=opts, typ=GetExpressRoutePortResult, package_ref=_utilities.get_package())
