...
class GetFlowLogResult:
    ...
    A flow log resource.
    """
    def __init__(__self__, azure_api_version=None, enabled=None, etag=None, flow_analytics_configuration=None, format=None, id=None, location=None, name=None, provisioning_state=None, retention_policy=None, storage_id=None, tags=None, target_resource_guid=None, target_resource_id=None, type=None):
...
def get_flow_log(flow_log_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getFlowLog', __args__, opts=opts, typ=GetFlowLogResult, package_ref=_utilities.get_package()).value
...
def get_flow_log_output(flow_log_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getFlowLog', __args__, opts=opts, typ=GetFlowLogResult, package_ref=_utilities.get_package())
