...
def get_security_rule(network_security_group_name: Optional[builtins.str] = None,
    ...
    :param builtins.str security_rule_name: The name of the security rule.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getSecurityRule', __args__, opts=opts, typ=GetSecurityRuleResult, package_ref=_utilities.get_package()).value
...
def get_security_rule_output(network_security_group_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getSecurityRule', __args__, opts=opts, typ=GetSecurityRuleResult, package_ref=_utilities.get_package())
