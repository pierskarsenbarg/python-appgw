...
def get_express_route_gateway(express_route_gateway_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getExpressRouteGateway', __args__, opts=opts, typ=GetExpressRouteGatewayResult, package_ref=_utilities.get_package()).value
...
def get_express_route_gateway_output(express_route_gateway_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getExpressRouteGateway', __args__, opts=opts, typ=GetExpressRouteGatewayResult, package_ref=_utilities.get_package())
