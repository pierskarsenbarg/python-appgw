...
def get_active_sessions(bastion_host_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getActiveSessions', __args__, opts=opts, typ=GetActiveSessionsResult, package_ref=_utilities.get_package()).value

    return AwaitableGetActiveSessionsResult(
        next_link=pulumi.get(__ret__, 'next_link'),
        value=pulumi.get(__ret__, 'value'))
def get_active_sessions_output(bastion_host_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getActiveSessions', __args__, opts=opts, typ=GetActiveSessionsResult, package_ref=_utilities.get_package())
