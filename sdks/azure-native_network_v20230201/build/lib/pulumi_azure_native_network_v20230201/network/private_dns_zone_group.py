...
class PrivateDnsZoneGroupArgs:
    def __init__(__self__, *,
                 private_endpoint_name: pulumi.Input[builtins.str],
                 ...
                 private_dns_zone_group_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] name: Name of the resource that is unique within a resource group. This name can be used to access the resource.
        ...
        :param pulumi.Input[builtins.str] private_dns_zone_group_name: The name of the private dns zone group.
        """
    ...
    def private_endpoint_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def private_endpoint_name(self, value: pulumi.Input[builtins.str]):
    ...
    def private_dns_zone_group_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def private_dns_zone_group_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "private_dns_zone_group_name", value)


@pulumi.type_token("azure-native_network_v20230201:network:PrivateDnsZoneGroup")
