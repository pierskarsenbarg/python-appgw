...
class GetVirtualHubRouteTableV2Result:
    ...
    """
    def __init__(__self__, attached_connections=None, azure_api_version=None, etag=None, id=None, name=None, provisioning_state=None, routes=None):
    ...
    def attached_connections(self) -> Optional[Sequence[builtins.str]]:
        """
...
def get_virtual_hub_route_table_v2(resource_group_name: Optional[builtins.str] = None,
    ...
    :param builtins.str resource_group_name: The resource group name of the VirtualHubRouteTableV2.
    :param builtins.str route_table_name: The name of the VirtualHubRouteTableV2.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getVirtualHubRouteTableV2', __args__, opts=opts, typ=GetVirtualHubRouteTableV2Result, package_ref=_utilities.get_package()).value
...
def get_virtual_hub_route_table_v2_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getVirtualHubRouteTableV2', __args__, opts=opts, typ=GetVirtualHubRouteTableV2Result, package_ref=_utilities.get_package())
