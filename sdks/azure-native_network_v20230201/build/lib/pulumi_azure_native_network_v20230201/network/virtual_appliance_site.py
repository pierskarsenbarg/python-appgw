...
class VirtualApplianceSiteArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] address_prefix: Address Prefix.
        :param pulumi.Input[builtins.str] id: Resource ID.
        :param pulumi.Input[builtins.str] name: Name of the virtual appliance site.
...
@pulumi.type_token("azure-native_network_v20230201:network:VirtualApplianceSite")
