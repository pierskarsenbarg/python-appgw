...
def get_public_ip_prefix(expand: Optional[builtins.str] = None,
                         public_ip_prefix_name: Optional[builtins.str] = None,
    ...
    :param builtins.str public_ip_prefix_name: The name of the public IP prefix.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getPublicIPPrefix', __args__, opts=opts, typ=GetPublicIPPrefixResult, package_ref=_utilities.get_package()).value
...
def get_public_ip_prefix_output(expand: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getPublicIPPrefix', __args__, opts=opts, typ=GetPublicIPPrefixResult, package_ref=_utilities.get_package())
