...
def get_vpn_server_configuration(resource_group_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getVpnServerConfiguration', __args__, opts=opts, typ=GetVpnServerConfigurationResult, package_ref=_utilities.get_package()).value
...
def get_vpn_server_configuration_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getVpnServerConfiguration', __args__, opts=opts, typ=GetVpnServerConfigurationResult, package_ref=_utilities.get_package())
