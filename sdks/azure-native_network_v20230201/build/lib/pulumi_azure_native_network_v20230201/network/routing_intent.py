...
class RoutingIntentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: The resource group name of the RoutingIntent.
        ...
        :param pulumi.Input[builtins.str] routing_intent_name: The name of the per VirtualHub singleton Routing Intent resource.
    ...
    def routing_intent_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def routing_intent_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("azure-native_network_v20230201:network:RoutingIntent")
class RoutingIntent(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20210501:RoutingIntent"), pulumi.Alias(type_="azure-native:network/v20210801:RoutingIntent"), pulumi.Alias(type_="azure-native:network/v20220101:RoutingIntent"), pulumi.Alias(type_="azure-native:network/v20220501:RoutingIntent"), pulumi.Alias(type_="azure-native:network/v20220701:RoutingIntent"), pulumi.Alias(type_="azure-native:network/v20220901:RoutingIntent"), pulumi.Alias(type_="azure-native:network/v20221101:RoutingIntent"), pulumi.Alias(type_="azure-native:network/v20230401:RoutingIntent"), pulumi.Alias(type_="azure-native:network/v20230501:RoutingIntent"), pulumi.Alias(type_="azure-native:network/v20230601:RoutingIntent"), pulumi.Alias(type_="azure-native:network/v20230901:RoutingIntent"), pulumi.Alias(type_="azure-native:network/v20231101:RoutingIntent"), pulumi.Alias(type_="azure-native:network/v20240101:RoutingIntent"), pulumi.Alias(type_="azure-native:network/v20240301:RoutingIntent"), pulumi.Alias(type_="azure-native:network/v20240501:RoutingIntent"), pulumi.Alias(type_="azure-native:network/v20240701:RoutingIntent"), pulumi.Alias(type_="azure-native:network:RoutingIntent")])
