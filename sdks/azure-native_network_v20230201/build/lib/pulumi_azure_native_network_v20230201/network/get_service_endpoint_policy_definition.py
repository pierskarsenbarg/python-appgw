...
def get_service_endpoint_policy_definition(resource_group_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getServiceEndpointPolicyDefinition', __args__, opts=opts, typ=GetServiceEndpointPolicyDefinitionResult, package_ref=_utilities.get_package()).value
...
def get_service_endpoint_policy_definition_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getServiceEndpointPolicyDefinition', __args__, opts=opts, typ=GetServiceEndpointPolicyDefinitionResult, package_ref=_utilities.get_package())
