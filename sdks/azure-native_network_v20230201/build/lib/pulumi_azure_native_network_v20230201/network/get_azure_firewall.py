...
def get_azure_firewall(azure_firewall_name: Optional[builtins.str] = None,
    ...
    :param builtins.str azure_firewall_name: The name of the Azure Firewall.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getAzureFirewall', __args__, opts=opts, typ=GetAzureFirewallResult, package_ref=_utilities.get_package()).value
...
def get_azure_firewall_output(azure_firewall_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getAzureFirewall', __args__, opts=opts, typ=GetAzureFirewallResult, package_ref=_utilities.get_package())
