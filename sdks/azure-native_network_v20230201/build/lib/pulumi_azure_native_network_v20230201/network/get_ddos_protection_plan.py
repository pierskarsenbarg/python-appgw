...
def get_ddos_protection_plan(ddos_protection_plan_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getDdosProtectionPlan', __args__, opts=opts, typ=GetDdosProtectionPlanResult, package_ref=_utilities.get_package()).value
...
def get_ddos_protection_plan_output(ddos_protection_plan_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getDdosProtectionPlan', __args__, opts=opts, typ=GetDdosProtectionPlanResult, package_ref=_utilities.get_package())
