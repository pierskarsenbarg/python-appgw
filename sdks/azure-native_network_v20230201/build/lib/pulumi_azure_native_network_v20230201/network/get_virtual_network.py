...
class GetVirtualNetworkResult:
    ...
    """
    def __init__(__self__, address_space=None, azure_api_version=None, bgp_communities=None, ddos_protection_plan=None, dhcp_options=None, enable_ddos_protection=None, enable_vm_protection=None, encryption=None, etag=None, extended_location=None, flow_logs=None, flow_timeout_in_minutes=None, id=None, ip_allocations=None, location=None, name=None, provisioning_state=None, resource_guid=None, subnets=None, tags=None, type=None, virtual_network_peerings=None):
...
def get_virtual_network(expand: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getVirtualNetwork', __args__, opts=opts, typ=GetVirtualNetworkResult, package_ref=_utilities.get_package()).value
...
def get_virtual_network_output(expand: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getVirtualNetwork', __args__, opts=opts, typ=GetVirtualNetworkResult, package_ref=_utilities.get_package())
