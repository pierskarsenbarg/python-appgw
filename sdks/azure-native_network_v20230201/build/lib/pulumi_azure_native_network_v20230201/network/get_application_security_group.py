...
def get_application_security_group(application_security_group_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getApplicationSecurityGroup', __args__, opts=opts, typ=GetApplicationSecurityGroupResult, package_ref=_utilities.get_package()).value
...
def get_application_security_group_output(application_security_group_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getApplicationSecurityGroup', __args__, opts=opts, typ=GetApplicationSecurityGroupResult, package_ref=_utilities.get_package())
