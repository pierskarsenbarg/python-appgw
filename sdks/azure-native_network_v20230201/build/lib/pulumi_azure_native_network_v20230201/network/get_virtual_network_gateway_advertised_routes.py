...
def get_virtual_network_gateway_advertised_routes(peer: Optional[builtins.str] = None,
    ...
    :param builtins.str peer: The IP address of the peer.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getVirtualNetworkGatewayAdvertisedRoutes', __args__, opts=opts, typ=GetVirtualNetworkGatewayAdvertisedRoutesResult, package_ref=_utilities.get_package()).value

    return AwaitableGetVirtualNetworkGatewayAdvertisedRoutesResult(
        value=pulumi.get(__ret__, 'value'))
def get_virtual_network_gateway_advertised_routes_output(peer: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getVirtualNetworkGatewayAdvertisedRoutes', __args__, opts=opts, typ=GetVirtualNetworkGatewayAdvertisedRoutesResult, package_ref=_utilities.get_package())
