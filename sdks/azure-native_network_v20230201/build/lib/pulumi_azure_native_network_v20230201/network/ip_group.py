...
class IpGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ip_addresses: IpAddresses/IpAddressPrefixes in the IpGroups resource.
        :param pulumi.Input[builtins.str] ip_groups_name: The name of the ipGroups.
    ...
    def ip_groups_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def ip_groups_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("azure-native_network_v20230201:network:IpGroup")
