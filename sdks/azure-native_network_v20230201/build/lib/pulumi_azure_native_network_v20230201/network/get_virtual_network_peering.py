...
class GetVirtualNetworkPeeringResult:
    ...
    def do_not_verify_remote_gateways(self) -> Optional[builtins.bool]:
        """
    ...
    def peering_state(self) -> Optional[builtins.str]:
        """
    ...
    def peering_sync_level(self) -> Optional[builtins.str]:
        """
...
def get_virtual_network_peering(resource_group_name: Optional[builtins.str] = None,
                                virtual_network_name: Optional[builtins.str] = None,
                                virtual_network_peering_name: Optional[builtins.str] = None,
    ...
    :param builtins.str virtual_network_peering_name: The name of the virtual network peering.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getVirtualNetworkPeering', __args__, opts=opts, typ=GetVirtualNetworkPeeringResult, package_ref=_utilities.get_package()).value
...
def get_virtual_network_peering_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getVirtualNetworkPeering', __args__, opts=opts, typ=GetVirtualNetworkPeeringResult, package_ref=_utilities.get_package())
