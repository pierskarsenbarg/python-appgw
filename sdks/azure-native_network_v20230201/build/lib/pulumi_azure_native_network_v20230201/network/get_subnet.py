...
def get_subnet(expand: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getSubnet', __args__, opts=opts, typ=GetSubnetResult, package_ref=_utilities.get_package()).value
...
def get_subnet_output(expand: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getSubnet', __args__, opts=opts, typ=GetSubnetResult, package_ref=_utilities.get_package())
