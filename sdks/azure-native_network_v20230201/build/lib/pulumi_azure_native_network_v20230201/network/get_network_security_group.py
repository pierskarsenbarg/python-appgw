...
def get_network_security_group(expand: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getNetworkSecurityGroup', __args__, opts=opts, typ=GetNetworkSecurityGroupResult, package_ref=_utilities.get_package()).value
...
def get_network_security_group_output(expand: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getNetworkSecurityGroup', __args__, opts=opts, typ=GetNetworkSecurityGroupResult, package_ref=_utilities.get_package())
