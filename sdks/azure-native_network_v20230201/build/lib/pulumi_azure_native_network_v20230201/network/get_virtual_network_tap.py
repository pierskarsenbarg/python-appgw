...
def get_virtual_network_tap(resource_group_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getVirtualNetworkTap', __args__, opts=opts, typ=GetVirtualNetworkTapResult, package_ref=_utilities.get_package()).value
...
def get_virtual_network_tap_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getVirtualNetworkTap', __args__, opts=opts, typ=GetVirtualNetworkTapResult, package_ref=_utilities.get_package())
