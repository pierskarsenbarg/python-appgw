...
def get_route(resource_group_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getRoute', __args__, opts=opts, typ=GetRouteResult, package_ref=_utilities.get_package()).value
...
def get_route_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getRoute', __args__, opts=opts, typ=GetRouteResult, package_ref=_utilities.get_package())
