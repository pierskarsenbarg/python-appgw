...
def get_virtual_network_gateway_connection_ike_sas(resource_group_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getVirtualNetworkGatewayConnectionIkeSas', __args__, opts=opts, typ=GetVirtualNetworkGatewayConnectionIkeSasResult, package_ref=_utilities.get_package()).value
...
def get_virtual_network_gateway_connection_ike_sas_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getVirtualNetworkGatewayConnectionIkeSas', __args__, opts=opts, typ=GetVirtualNetworkGatewayConnectionIkeSasResult, package_ref=_utilities.get_package())
