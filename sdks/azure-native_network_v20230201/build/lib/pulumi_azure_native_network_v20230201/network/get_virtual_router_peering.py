...
def get_virtual_router_peering(peering_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getVirtualRouterPeering', __args__, opts=opts, typ=GetVirtualRouterPeeringResult, package_ref=_utilities.get_package()).value
...
def get_virtual_router_peering_output(peering_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getVirtualRouterPeering', __args__, opts=opts, typ=GetVirtualRouterPeeringResult, package_ref=_utilities.get_package())
