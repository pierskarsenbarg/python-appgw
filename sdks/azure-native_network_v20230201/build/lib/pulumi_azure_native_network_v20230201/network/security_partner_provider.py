...
class SecurityPartnerProviderArgs:
    def __init__(__self__, *,
                 ...
                 security_provider_name: Optional[pulumi.Input[Union[builtins.str, 'SecurityProviderName']]] = None,
        ...
        :param pulumi.Input[builtins.str] security_partner_provider_name: The name of the Security Partner Provider.
        :param pulumi.Input[Union[builtins.str, 'SecurityProviderName']] security_provider_name: The security provider name.
    ...
    def security_partner_provider_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def security_partner_provider_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "security_partner_provider_name", value)

    @property
    @pulumi.getter(name="securityProviderName")
    def security_provider_name(self) -> Optional[pulumi.Input[Union[builtins.str, 'SecurityProviderName']]]:
        """
    ...
    def security_provider_name(self, value: Optional[pulumi.Input[Union[builtins.str, 'SecurityProviderName']]]):
...
@pulumi.type_token("azure-native_network_v20230201:network:SecurityPartnerProvider")
