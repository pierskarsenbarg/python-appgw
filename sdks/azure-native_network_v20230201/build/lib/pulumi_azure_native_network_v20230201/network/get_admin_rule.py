...
def get_admin_rule(configuration_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getAdminRule', __args__, opts=opts, typ=GetAdminRuleResult, package_ref=_utilities.get_package()).value
...
def get_admin_rule_output(configuration_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getAdminRule', __args__, opts=opts, typ=GetAdminRuleResult, package_ref=_utilities.get_package())
