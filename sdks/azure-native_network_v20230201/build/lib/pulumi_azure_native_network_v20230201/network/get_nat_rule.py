...
def get_nat_rule(gateway_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getNatRule', __args__, opts=opts, typ=GetNatRuleResult, package_ref=_utilities.get_package()).value
...
def get_nat_rule_output(gateway_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getNatRule', __args__, opts=opts, typ=GetNatRuleResult, package_ref=_utilities.get_package())
