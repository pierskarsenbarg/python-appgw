...
def get_network_profile(expand: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getNetworkProfile', __args__, opts=opts, typ=GetNetworkProfileResult, package_ref=_utilities.get_package()).value
...
def get_network_profile_output(expand: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getNetworkProfile', __args__, opts=opts, typ=GetNetworkProfileResult, package_ref=_utilities.get_package())
