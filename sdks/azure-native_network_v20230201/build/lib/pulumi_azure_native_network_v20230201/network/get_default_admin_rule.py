...
def get_default_admin_rule(configuration_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getDefaultAdminRule', __args__, opts=opts, typ=GetDefaultAdminRuleResult, package_ref=_utilities.get_package()).value
...
def get_default_admin_rule_output(configuration_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getDefaultAdminRule', __args__, opts=opts, typ=GetDefaultAdminRuleResult, package_ref=_utilities.get_package())
