...
def get_virtual_appliance_site(network_virtual_appliance_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getVirtualApplianceSite', __args__, opts=opts, typ=GetVirtualApplianceSiteResult, package_ref=_utilities.get_package()).value
...
def get_virtual_appliance_site_output(network_virtual_appliance_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getVirtualApplianceSite', __args__, opts=opts, typ=GetVirtualApplianceSiteResult, package_ref=_utilities.get_package())
