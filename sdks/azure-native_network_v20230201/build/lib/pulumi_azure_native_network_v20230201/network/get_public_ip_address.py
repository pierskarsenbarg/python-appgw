...
def get_public_ip_address(expand: Optional[builtins.str] = None,
                          public_ip_address_name: Optional[builtins.str] = None,
    ...
    :param builtins.str public_ip_address_name: The name of the public IP address.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getPublicIPAddress', __args__, opts=opts, typ=GetPublicIPAddressResult, package_ref=_utilities.get_package()).value
...
def get_public_ip_address_output(expand: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getPublicIPAddress', __args__, opts=opts, typ=GetPublicIPAddressResult, package_ref=_utilities.get_package())
