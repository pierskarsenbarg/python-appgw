...
class GetPrivateLinkServiceResult:
    ...
    """
    def __init__(__self__, alias=None, auto_approval=None, azure_api_version=None, enable_proxy_protocol=None, etag=None, extended_location=None, fqdns=None, id=None, ip_configurations=None, load_balancer_frontend_ip_configurations=None, location=None, name=None, network_interfaces=None, private_endpoint_connections=None, provisioning_state=None, tags=None, type=None, visibility=None):
...
def get_private_link_service(expand: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getPrivateLinkService', __args__, opts=opts, typ=GetPrivateLinkServiceResult, package_ref=_utilities.get_package()).value
...
def get_private_link_service_output(expand: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getPrivateLinkService', __args__, opts=opts, typ=GetPrivateLinkServiceResult, package_ref=_utilities.get_package())
