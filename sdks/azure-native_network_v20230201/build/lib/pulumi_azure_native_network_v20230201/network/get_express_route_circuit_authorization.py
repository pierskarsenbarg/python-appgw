...
class GetExpressRouteCircuitAuthorizationResult:
    ...
    """
    def __init__(__self__, authorization_key=None, authorization_use_status=None, azure_api_version=None, etag=None, id=None, name=None, provisioning_state=None, type=None):
...
def get_express_route_circuit_authorization(authorization_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getExpressRouteCircuitAuthorization', __args__, opts=opts, typ=GetExpressRouteCircuitAuthorizationResult, package_ref=_utilities.get_package()).value
...
def get_express_route_circuit_authorization_output(authorization_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getExpressRouteCircuitAuthorization', __args__, opts=opts, typ=GetExpressRouteCircuitAuthorizationResult, package_ref=_utilities.get_package())
