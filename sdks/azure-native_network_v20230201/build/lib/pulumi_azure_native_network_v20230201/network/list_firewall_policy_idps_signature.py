...
def list_firewall_policy_idps_signature(filters: Optional[Sequence[Union['FilterItems', 'FilterItemsDict']]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:listFirewallPolicyIdpsSignature', __args__, opts=opts, typ=ListFirewallPolicyIdpsSignatureResult, package_ref=_utilities.get_package()).value
...
def list_firewall_policy_idps_signature_output(filters: Optional[pulumi.Input[Optional[Sequence[Union['FilterItems', 'FilterItemsDict']]]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:listFirewallPolicyIdpsSignature', __args__, opts=opts, typ=ListFirewallPolicyIdpsSignatureResult, package_ref=_utilities.get_package())
