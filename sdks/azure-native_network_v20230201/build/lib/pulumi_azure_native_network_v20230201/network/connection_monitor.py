...
class ConnectionMonitorArgs:
    def __init__(__self__, *,
                 ...
                 connection_monitor_name: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 migrate: Optional[pulumi.Input[builtins.str]] = None,
                 monitoring_interval_in_seconds: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] network_watcher_name: The name of the Network Watcher resource.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group containing Network Watcher.
        :param pulumi.Input[builtins.bool] auto_start: Determines if the connection monitor will start automatically once created.
        :param pulumi.Input[builtins.str] connection_monitor_name: The name of the connection monitor.
        ...
        :param pulumi.Input[builtins.str] location: Connection monitor location.
        :param pulumi.Input[builtins.str] migrate: Value indicating whether connection monitor V1 should be migrated to V2 format.
        :param pulumi.Input[builtins.int] monitoring_interval_in_seconds: Monitoring interval in seconds.
        :param pulumi.Input[builtins.str] notes: Optional notes to be associated with the connection monitor.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Connection monitor tags.
    ...
    def connection_monitor_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def connection_monitor_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter
    def migrate(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @migrate.setter
    def migrate(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "migrate", value)

    @property
    @pulumi.getter(name="monitoringIntervalInSeconds")
    def monitoring_interval_in_seconds(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def monitoring_interval_in_seconds(self, value: Optional[pulumi.Input[builtins.int]]):
...
@pulumi.type_token("azure-native_network_v20230201:network:ConnectionMonitor")
class ConnectionMonitor(pulumi.CustomResource):
    ...
    def connection_monitor_type(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="monitoringIntervalInSeconds")
    def monitoring_interval_in_seconds(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Monitoring interval in seconds.
        """
        return pulumi.get(self, "monitoring_interval_in_seconds")
