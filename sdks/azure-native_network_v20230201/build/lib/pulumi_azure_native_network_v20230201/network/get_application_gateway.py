...
class GetApplicationGatewayResult:
    ...
    def default_predefined_ssl_policy(self) -> builtins.str:
        """
    ...
    def force_firewall_policy_association(self) -> Optional[builtins.bool]:
        """
...
def get_application_gateway(application_gateway_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getApplicationGateway', __args__, opts=opts, typ=GetApplicationGatewayResult, package_ref=_utilities.get_package()).value
...
def get_application_gateway_output(application_gateway_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getApplicationGateway', __args__, opts=opts, typ=GetApplicationGatewayResult, package_ref=_utilities.get_package())
