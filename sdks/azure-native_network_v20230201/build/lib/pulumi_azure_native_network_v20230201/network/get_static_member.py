...
def get_static_member(network_group_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getStaticMember', __args__, opts=opts, typ=GetStaticMemberResult, package_ref=_utilities.get_package()).value
...
def get_static_member_output(network_group_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getStaticMember', __args__, opts=opts, typ=GetStaticMemberResult, package_ref=_utilities.get_package())
