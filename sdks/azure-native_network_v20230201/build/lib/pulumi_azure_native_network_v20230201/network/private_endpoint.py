...
class PrivateEndpointArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] custom_network_interface_name: The custom name of the network interface attached to the private endpoint.
...
@pulumi.type_token("azure-native_network_v20230201:network:PrivateEndpoint")
