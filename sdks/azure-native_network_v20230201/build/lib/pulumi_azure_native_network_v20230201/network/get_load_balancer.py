...
def get_load_balancer(expand: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getLoadBalancer', __args__, opts=opts, typ=GetLoadBalancerResult, package_ref=_utilities.get_package()).value
...
def get_load_balancer_output(expand: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getLoadBalancer', __args__, opts=opts, typ=GetLoadBalancerResult, package_ref=_utilities.get_package())
