...
class GetCustomIPPrefixResult:
    ...
    def authorization_message(self) -> Optional[builtins.str]:
        """
    ...
    def commissioned_state(self) -> Optional[builtins.str]:
        """
    ...
    def express_route_advertise(self) -> Optional[builtins.bool]:
        """
    ...
    def failed_reason(self) -> builtins.str:
        """
    ...
    def no_internet_advertise(self) -> Optional[builtins.bool]:
        """
    ...
    def signed_message(self) -> Optional[builtins.str]:
        """
...
def get_custom_ip_prefix(custom_ip_prefix_name: Optional[builtins.str] = None,
    ...
    :param builtins.str custom_ip_prefix_name: The name of the custom IP prefix.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getCustomIPPrefix', __args__, opts=opts, typ=GetCustomIPPrefixResult, package_ref=_utilities.get_package()).value
...
def get_custom_ip_prefix_output(custom_ip_prefix_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getCustomIPPrefix', __args__, opts=opts, typ=GetCustomIPPrefixResult, package_ref=_utilities.get_package())
