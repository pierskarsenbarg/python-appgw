...
def get_nat_gateway(expand: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getNatGateway', __args__, opts=opts, typ=GetNatGatewayResult, package_ref=_utilities.get_package()).value
...
def get_nat_gateway_output(expand: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getNatGateway', __args__, opts=opts, typ=GetNatGatewayResult, package_ref=_utilities.get_package())
