...
class VpnServerConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: The resource group name of the VpnServerConfiguration.
        ...
        :param pulumi.Input[builtins.str] vpn_server_configuration_name: The name of the VpnServerConfiguration being created or updated.
        """
    ...
    def vpn_server_configuration_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def vpn_server_configuration_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "vpn_server_configuration_name", value)


@pulumi.type_token("azure-native_network_v20230201:network:VpnServerConfiguration")
