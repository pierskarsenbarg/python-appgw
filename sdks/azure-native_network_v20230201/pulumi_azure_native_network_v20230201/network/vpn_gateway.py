...
class VpnGatewayArgs:
    def __init__(__self__, *,
                 ...
                 is_routing_preference_internet: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 vpn_gateway_scale_unit: Optional[pulumi.Input[builtins.int]] = None):
        """
        ...
        :param pulumi.Input[builtins.bool] enable_bgp_route_translation_for_nat: Enable BGP routes translation for NAT on this VpnGateway.
        :param pulumi.Input[builtins.str] gateway_name: The name of the gateway.
        :param pulumi.Input[builtins.str] id: Resource ID.
        :param pulumi.Input[builtins.bool] is_routing_preference_internet: Enable Routing Preference property for the Public IP Interface of the VpnGateway.
        ...
        :param pulumi.Input[builtins.int] vpn_gateway_scale_unit: The scale unit for this vpn gateway.
        """
    ...
    def is_routing_preference_internet(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_routing_preference_internet(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def vpn_gateway_scale_unit(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def vpn_gateway_scale_unit(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "vpn_gateway_scale_unit", value)


@pulumi.type_token("azure-native_network_v20230201:network:VpnGateway")
class VpnGateway(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="isRoutingPreferenceInternet")
    def is_routing_preference_internet(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Enable Routing Preference property for the Public IP Interface of the VpnGateway.
        """
        return pulumi.get(self, "is_routing_preference_internet")
    ...
    @property
    @pulumi.getter(name="vpnGatewayScaleUnit")
    def vpn_gateway_scale_unit(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The scale unit for this vpn gateway.
        """
        return pulumi.get(self, "vpn_gateway_scale_unit")
