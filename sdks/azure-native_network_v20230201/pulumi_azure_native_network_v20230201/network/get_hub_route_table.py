...
def get_hub_route_table(resource_group_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getHubRouteTable', __args__, opts=opts, typ=GetHubRouteTableResult, package_ref=_utilities.get_package()).value
...
def get_hub_route_table_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getHubRouteTable', __args__, opts=opts, typ=GetHubRouteTableResult, package_ref=_utilities.get_package())
