...
class VirtualNetworkArgs:
    def __init__(__self__, *,
                 ...
                 enable_vm_protection: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.bool] enable_ddos_protection: Indicates if DDoS protection is enabled for all the protected resources in the virtual network. It requires a DDoS protection plan associated with the resource.
        :param pulumi.Input[builtins.bool] enable_vm_protection: Indicates if VM protection is enabled for all the subnets in the virtual network.
        ...
        :param pulumi.Input[builtins.int] flow_timeout_in_minutes: The FlowTimeout value (in minutes) for the Virtual Network
    ...
    def enable_vm_protection(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_vm_protection(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def flow_timeout_in_minutes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def flow_timeout_in_minutes(self, value: Optional[pulumi.Input[builtins.int]]):
...
@pulumi.type_token("azure-native_network_v20230201:network:VirtualNetwork")
class VirtualNetwork(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="enableDdosProtection")
    def enable_ddos_protection(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates if DDoS protection is enabled for all the protected resources in the virtual network. It requires a DDoS protection plan associated with the resource.
        """
        return pulumi.get(self, "enable_ddos_protection")
    ...
    @property
    @pulumi.getter(name="enableVmProtection")
    def enable_vm_protection(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates if VM protection is enabled for all the subnets in the virtual network.
        """
        return pulumi.get(self, "enable_vm_protection")
    ...
    @property
    @pulumi.getter(name="flowTimeoutInMinutes")
    def flow_timeout_in_minutes(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The FlowTimeout value (in minutes) for the Virtual Network
        """
        return pulumi.get(self, "flow_timeout_in_minutes")
