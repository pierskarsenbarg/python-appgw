...
class P2sVpnGatewayArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: The resource group name of the P2SVpnGateway.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] custom_dns_servers: List of all customer specified DNS servers IP addresses.
        :param pulumi.Input[builtins.str] gateway_name: The name of the gateway.
        :param pulumi.Input[builtins.str] id: Resource ID.
        :param pulumi.Input[builtins.bool] is_routing_preference_internet: Enable Routing Preference property for the Public IP Interface of the P2SVpnGateway.
        ...
        :param pulumi.Input[builtins.int] vpn_gateway_scale_unit: The scale unit for this p2s vpn gateway.
...
@pulumi.type_token("azure-native_network_v20230201:network:P2sVpnGateway")
