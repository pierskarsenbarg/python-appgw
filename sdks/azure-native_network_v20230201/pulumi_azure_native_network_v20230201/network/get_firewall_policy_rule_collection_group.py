...
class GetFirewallPolicyRuleCollectionGroupResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, etag=None, id=None, name=None, priority=None, provisioning_state=None, rule_collections=None, type=None):
...
def get_firewall_policy_rule_collection_group(firewall_policy_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getFirewallPolicyRuleCollectionGroup', __args__, opts=opts, typ=GetFirewallPolicyRuleCollectionGroupResult, package_ref=_utilities.get_package()).value
...
def get_firewall_policy_rule_collection_group_output(firewall_policy_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getFirewallPolicyRuleCollectionGroup', __args__, opts=opts, typ=GetFirewallPolicyRuleCollectionGroupResult, package_ref=_utilities.get_package())
