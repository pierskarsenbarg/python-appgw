...
class ExpressRoutePortArgs:
    def __init__(__self__, *,
                 ...
                 billing_type: Optional[pulumi.Input[Union[builtins.str, 'ExpressRoutePortsBillingType']]] = None,
                 encapsulation: Optional[pulumi.Input[Union[builtins.str, 'ExpressRoutePortsEncapsulation']]] = None,
        ...
        :param pulumi.Input[builtins.int] bandwidth_in_gbps: Bandwidth of procured ports in Gbps.
        :param pulumi.Input[Union[builtins.str, 'ExpressRoutePortsBillingType']] billing_type: The billing type of the ExpressRoutePort resource.
        :param pulumi.Input[Union[builtins.str, 'ExpressRoutePortsEncapsulation']] encapsulation: Encapsulation method on physical ports.
        :param pulumi.Input[builtins.str] express_route_port_name: The name of the ExpressRoutePort resource.
        ...
        :param pulumi.Input[builtins.str] peering_location: The name of the peering location that the ExpressRoutePort is mapped to physically.
    ...
    def billing_type(self) -> Optional[pulumi.Input[Union[builtins.str, 'ExpressRoutePortsBillingType']]]:
        """
    ...
    @billing_type.setter
    def billing_type(self, value: Optional[pulumi.Input[Union[builtins.str, 'ExpressRoutePortsBillingType']]]):
        pulumi.set(self, "billing_type", value)

    @property
    @pulumi.getter
    def encapsulation(self) -> Optional[pulumi.Input[Union[builtins.str, 'ExpressRoutePortsEncapsulation']]]:
        """
    ...
    def encapsulation(self, value: Optional[pulumi.Input[Union[builtins.str, 'ExpressRoutePortsEncapsulation']]]):
...
@pulumi.type_token("azure-native_network_v20230201:network:ExpressRoutePort")
class ExpressRoutePort(pulumi.CustomResource):
    ...
    def allocation_date(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="bandwidthInGbps")
    def bandwidth_in_gbps(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Bandwidth of procured ports in Gbps.
        """
        return pulumi.get(self, "bandwidth_in_gbps")
    ...
    def provisioned_bandwidth_in_gbps(self) -> pulumi.Output[builtins.float]:
        """
