...
def get_vpn_gateway(gateway_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getVpnGateway', __args__, opts=opts, typ=GetVpnGatewayResult, package_ref=_utilities.get_package()).value
...
def get_vpn_gateway_output(gateway_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getVpnGateway', __args__, opts=opts, typ=GetVpnGatewayResult, package_ref=_utilities.get_package())
