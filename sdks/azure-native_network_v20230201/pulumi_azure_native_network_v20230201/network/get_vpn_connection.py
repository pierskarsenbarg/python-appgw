...
def get_vpn_connection(connection_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getVpnConnection', __args__, opts=opts, typ=GetVpnConnectionResult, package_ref=_utilities.get_package()).value
...
def get_vpn_connection_output(connection_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getVpnConnection', __args__, opts=opts, typ=GetVpnConnectionResult, package_ref=_utilities.get_package())
