...
class NetworkInterfaceTapConfigurationArgs:
    def __init__(__self__, *,
                 network_interface_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] tap_configuration_name: The name of the tap configuration.
    ...
    def network_interface_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def network_interface_name(self, value: pulumi.Input[builtins.str]):
    ...
    def tap_configuration_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def tap_configuration_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("azure-native_network_v20230201:network:NetworkInterfaceTapConfiguration")
