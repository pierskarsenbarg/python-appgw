...
def get_connection_monitor(connection_monitor_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getConnectionMonitor', __args__, opts=opts, typ=GetConnectionMonitorResult, package_ref=_utilities.get_package()).value
...
def get_connection_monitor_output(connection_monitor_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getConnectionMonitor', __args__, opts=opts, typ=GetConnectionMonitorResult, package_ref=_utilities.get_package())
