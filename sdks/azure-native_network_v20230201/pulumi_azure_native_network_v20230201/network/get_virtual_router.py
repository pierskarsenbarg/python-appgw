...
def get_virtual_router(expand: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getVirtualRouter', __args__, opts=opts, typ=GetVirtualRouterResult, package_ref=_utilities.get_package()).value
...
def get_virtual_router_output(expand: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getVirtualRouter', __args__, opts=opts, typ=GetVirtualRouterResult, package_ref=_utilities.get_package())
