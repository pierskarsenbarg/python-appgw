...
class NetworkGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: A description of the network group.
    ...
    def network_group_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def network_group_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "network_group_name", value)


@pulumi.type_token("azure-native_network_v20230201:network:NetworkGroup")
class NetworkGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20210201preview:NetworkGroup"), pulumi.Alias(type_="azure-native:network/v20210501preview:NetworkGroup"), pulumi.Alias(type_="azure-native:network/v20220101:NetworkGroup"), pulumi.Alias(type_="azure-native:network/v20220201preview:NetworkGroup"), pulumi.Alias(type_="azure-native:network/v20220401preview:NetworkGroup"), pulumi.Alias(type_="azure-native:network/v20220501:NetworkGroup"), pulumi.Alias(type_="azure-native:network/v20220701:NetworkGroup"), pulumi.Alias(type_="azure-native:network/v20220901:NetworkGroup"), pulumi.Alias(type_="azure-native:network/v20221101:NetworkGroup"), pulumi.Alias(type_="azure-native:network/v20230401:NetworkGroup"), pulumi.Alias(type_="azure-native:network/v20230501:NetworkGroup"), pulumi.Alias(type_="azure-native:network/v20230601:NetworkGroup"), pulumi.Alias(type_="azure-native:network/v20230901:NetworkGroup"), pulumi.Alias(type_="azure-native:network/v20231101:NetworkGroup"), pulumi.Alias(type_="azure-native:network/v20240101:NetworkGroup"), pulumi.Alias(type_="azure-native:network/v20240301:NetworkGroup"), pulumi.Alias(type_="azure-native:network/v20240501:NetworkGroup"), pulumi.Alias(type_="azure-native:network/v20240701:NetworkGroup"), pulumi.Alias(type_="azure-native:network:NetworkGroup")])
