...
class GetLocalNetworkGatewayResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, bgp_settings=None, etag=None, fqdn=None, gateway_ip_address=None, id=None, local_network_address_space=None, location=None, name=None, provisioning_state=None, resource_guid=None, tags=None, type=None):
    ...
    def gateway_ip_address(self) -> Optional[builtins.str]:
        """
...
def get_local_network_gateway(local_network_gateway_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getLocalNetworkGateway', __args__, opts=opts, typ=GetLocalNetworkGatewayResult, package_ref=_utilities.get_package()).value
...
def get_local_network_gateway_output(local_network_gateway_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getLocalNetworkGateway', __args__, opts=opts, typ=GetLocalNetworkGatewayResult, package_ref=_utilities.get_package())
