...
def get_route_filter(expand: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getRouteFilter', __args__, opts=opts, typ=GetRouteFilterResult, package_ref=_utilities.get_package()).value
...
def get_route_filter_output(expand: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getRouteFilter', __args__, opts=opts, typ=GetRouteFilterResult, package_ref=_utilities.get_package())
