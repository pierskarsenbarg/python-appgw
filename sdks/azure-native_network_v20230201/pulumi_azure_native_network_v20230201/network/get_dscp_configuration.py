...
def get_dscp_configuration(dscp_configuration_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getDscpConfiguration', __args__, opts=opts, typ=GetDscpConfigurationResult, package_ref=_utilities.get_package()).value
...
def get_dscp_configuration_output(dscp_configuration_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getDscpConfiguration', __args__, opts=opts, typ=GetDscpConfigurationResult, package_ref=_utilities.get_package())
