...
class RouteFilterArgs:
    ...
    def route_filter_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def route_filter_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("azure-native_network_v20230201:network:RouteFilter")
