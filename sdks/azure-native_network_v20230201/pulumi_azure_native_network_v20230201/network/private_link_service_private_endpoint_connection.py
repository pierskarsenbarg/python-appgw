...
class PrivateLinkServicePrivateEndpointConnectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] pe_connection_name: The name of the private end point connection.
...
@pulumi.type_token("azure-native_network_v20230201:network:PrivateLinkServicePrivateEndpointConnection")
class PrivateLinkServicePrivateEndpointConnection(pulumi.CustomResource):
    ...
    def private_endpoint_location(self) -> pulumi.Output[builtins.str]:
        """
