...
class ApplicationGatewayArgs:
    def __init__(__self__, *,
                 ...
                 force_firewall_policy_association: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.bool] enable_fips: Whether FIPS is enabled on the application gateway resource.
        :param pulumi.Input[builtins.bool] enable_http2: Whether HTTP2 is enabled on the application gateway resource.
        :param pulumi.Input['SubResourceArgs'] firewall_policy: Reference to the FirewallPolicy resource.
        :param pulumi.Input[builtins.bool] force_firewall_policy_association: If true, associates a firewall policy with an application gateway regardless whether the policy differs from the WAF Config.
    ...
    def application_gateway_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def application_gateway_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def force_firewall_policy_association(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def force_firewall_policy_association(self, value: Optional[pulumi.Input[builtins.bool]]):
...
@pulumi.type_token("azure-native_network_v20230201:network:ApplicationGateway")
class ApplicationGateway(pulumi.CustomResource):
    ...
    def default_predefined_ssl_policy(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="forceFirewallPolicyAssociation")
    def force_firewall_policy_association(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If true, associates a firewall policy with an application gateway regardless whether the policy differs from the WAF Config.
        """
        return pulumi.get(self, "force_firewall_policy_association")
