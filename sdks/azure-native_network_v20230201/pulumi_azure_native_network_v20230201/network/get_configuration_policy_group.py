...
def get_configuration_policy_group(configuration_policy_group_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getConfigurationPolicyGroup', __args__, opts=opts, typ=GetConfigurationPolicyGroupResult, package_ref=_utilities.get_package()).value
...
def get_configuration_policy_group_output(configuration_policy_group_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getConfigurationPolicyGroup', __args__, opts=opts, typ=GetConfigurationPolicyGroupResult, package_ref=_utilities.get_package())
