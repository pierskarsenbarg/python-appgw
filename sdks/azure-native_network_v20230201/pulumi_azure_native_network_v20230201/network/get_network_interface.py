...
class GetNetworkInterfaceResult:
    ...
    def hosted_workloads(self) -> Sequence[builtins.str]:
        """
    ...
    def migration_phase(self) -> Optional[builtins.str]:
        """
    ...
    def vnet_encryption_supported(self) -> builtins.bool:
        """
...
def get_network_interface(expand: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getNetworkInterface', __args__, opts=opts, typ=GetNetworkInterfaceResult, package_ref=_utilities.get_package()).value
...
def get_network_interface_output(expand: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getNetworkInterface', __args__, opts=opts, typ=GetNetworkInterfaceResult, package_ref=_utilities.get_package())
