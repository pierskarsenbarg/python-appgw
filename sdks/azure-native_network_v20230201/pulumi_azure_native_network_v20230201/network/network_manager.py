...
class NetworkManagerArgs:
    def __init__(__self__, *,
                 network_manager_scope_accesses: pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'ConfigurationType']]]],
    ...
    def network_manager_scope_accesses(self) -> pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'ConfigurationType']]]]:
        """
        Scope Access.
        """
    ...
    def network_manager_scope_accesses(self, value: pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'ConfigurationType']]]]):
...
@pulumi.type_token("azure-native_network_v20230201:network:NetworkManager")
class NetworkManager(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20210201preview:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20210501preview:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20220101:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20220201preview:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20220401preview:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20220501:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20220701:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20220901:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20221101:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20230401:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20230501:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20230601:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20230901:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20231101:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20240101:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20240101preview:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20240301:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20240501:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20240701:NetworkManager"), pulumi.Alias(type_="azure-native:network:NetworkManager")])
    ...
    @property
    @pulumi.getter(name="networkManagerScopeAccesses")
    def network_manager_scope_accesses(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Scope Access.
        """
        return pulumi.get(self, "network_manager_scope_accesses")
