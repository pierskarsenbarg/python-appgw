...
class FirewallPolicyRuleCollectionGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] priority: Priority of the Firewall Policy Rule Collection Group resource.
        :param pulumi.Input[builtins.str] rule_collection_group_name: The name of the FirewallPolicyRuleCollectionGroup.
    ...
    def rule_collection_group_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def rule_collection_group_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("azure-native_network_v20230201:network:FirewallPolicyRuleCollectionGroup")
