...
def get_admin_rule_collection(configuration_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getAdminRuleCollection', __args__, opts=opts, typ=GetAdminRuleCollectionResult, package_ref=_utilities.get_package()).value
...
def get_admin_rule_collection_output(configuration_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getAdminRuleCollection', __args__, opts=opts, typ=GetAdminRuleCollectionResult, package_ref=_utilities.get_package())
