...
class GetPacketCaptureResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, bytes_to_capture_per_packet=None, etag=None, filters=None, id=None, name=None, provisioning_state=None, scope=None, storage_location=None, target=None, target_type=None, time_limit_in_seconds=None, total_bytes_per_session=None):
...
def get_packet_capture(network_watcher_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getPacketCapture', __args__, opts=opts, typ=GetPacketCaptureResult, package_ref=_utilities.get_package()).value
...
def get_packet_capture_output(network_watcher_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getPacketCapture', __args__, opts=opts, typ=GetPacketCaptureResult, package_ref=_utilities.get_package())
