...
class ExpressRouteCircuitConnectionInitArgs:
    def __init__(__self__, *,
                 ...
                 peering_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] address_prefix: /29 IP address space to carve out Customer addresses for tunnels.
        :param pulumi.Input[builtins.str] authorization_key: The authorization key.
        :param pulumi.Input[builtins.str] connection_name: The name of the express route circuit connection.
    ...
    def peering_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @peering_name.setter
    def peering_name(self, value: pulumi.Input[builtins.str]):
...
@pulumi.type_token("azure-native_network_v20230201:network:ExpressRouteCircuitConnection")
