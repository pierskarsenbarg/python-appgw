...
class GetPrivateEndpointResult:
    ...
    def custom_network_interface_name(self) -> Optional[builtins.str]:
        """
...
def get_private_endpoint(expand: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getPrivateEndpoint', __args__, opts=opts, typ=GetPrivateEndpointResult, package_ref=_utilities.get_package()).value
...
def get_private_endpoint_output(expand: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getPrivateEndpoint', __args__, opts=opts, typ=GetPrivateEndpointResult, package_ref=_utilities.get_package())
