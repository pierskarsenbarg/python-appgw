...
class GetServiceEndpointPolicyResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, contextual_service_endpoint_policies=None, etag=None, id=None, kind=None, location=None, name=None, provisioning_state=None, resource_guid=None, service_alias=None, service_endpoint_policy_definitions=None, subnets=None, tags=None, type=None):
    ...
    def contextual_service_endpoint_policies(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def service_alias(self) -> Optional[builtins.str]:
        """
...
def get_service_endpoint_policy(expand: Optional[builtins.str] = None,
    ...
    :param builtins.str service_endpoint_policy_name: The name of the service endpoint policy.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getServiceEndpointPolicy', __args__, opts=opts, typ=GetServiceEndpointPolicyResult, package_ref=_utilities.get_package()).value
...
def get_service_endpoint_policy_output(expand: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getServiceEndpointPolicy', __args__, opts=opts, typ=GetServiceEndpointPolicyResult, package_ref=_utilities.get_package())
