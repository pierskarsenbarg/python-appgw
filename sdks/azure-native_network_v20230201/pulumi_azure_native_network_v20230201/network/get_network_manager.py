...
class GetNetworkManagerResult:
    ...
    def network_manager_scope_accesses(self) -> Sequence[builtins.str]:
        """
        Scope Access.
        """
...
def get_network_manager(network_manager_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getNetworkManager', __args__, opts=opts, typ=GetNetworkManagerResult, package_ref=_utilities.get_package()).value
...
def get_network_manager_output(network_manager_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getNetworkManager', __args__, opts=opts, typ=GetNetworkManagerResult, package_ref=_utilities.get_package())
