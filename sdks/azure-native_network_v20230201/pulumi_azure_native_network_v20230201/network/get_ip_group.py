...
def get_ip_group(expand: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getIpGroup', __args__, opts=opts, typ=GetIpGroupResult, package_ref=_utilities.get_package()).value
...
def get_ip_group_output(expand: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getIpGroup', __args__, opts=opts, typ=GetIpGroupResult, package_ref=_utilities.get_package())
