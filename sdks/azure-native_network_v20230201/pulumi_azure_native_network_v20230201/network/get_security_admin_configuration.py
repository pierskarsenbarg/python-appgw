...
class GetSecurityAdminConfigurationResult:
    ...
    """
    def __init__(__self__, apply_on_network_intent_policy_based_services=None, azure_api_version=None, description=None, etag=None, id=None, name=None, provisioning_state=None, resource_guid=None, system_data=None, type=None):
    ...
    def apply_on_network_intent_policy_based_services(self) -> Optional[Sequence[builtins.str]]:
        """
...
def get_security_admin_configuration(configuration_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getSecurityAdminConfiguration', __args__, opts=opts, typ=GetSecurityAdminConfigurationResult, package_ref=_utilities.get_package()).value
...
def get_security_admin_configuration_output(configuration_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getSecurityAdminConfiguration', __args__, opts=opts, typ=GetSecurityAdminConfigurationResult, package_ref=_utilities.get_package())
