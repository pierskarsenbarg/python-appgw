...
def list_network_manager_deployment_status(deployment_types: Optional[Sequence[Union[builtins.str, 'ConfigurationType']]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:listNetworkManagerDeploymentStatus', __args__, opts=opts, typ=ListNetworkManagerDeploymentStatusResult, package_ref=_utilities.get_package()).value
...
def list_network_manager_deployment_status_output(deployment_types: Optional[pulumi.Input[Optional[Sequence[Union[builtins.str, 'ConfigurationType']]]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:listNetworkManagerDeploymentStatus', __args__, opts=opts, typ=ListNetworkManagerDeploymentStatusResult, package_ref=_utilities.get_package())
