...
class FlowLogArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] storage_id: ID of the storage account which is used to store the flow log.
        :param pulumi.Input[builtins.str] target_resource_id: ID of network security group to which flow log will be applied.
        :param pulumi.Input[builtins.bool] enabled: Flag to enable/disable flow logging.
        ...
        :param pulumi.Input[builtins.str] flow_log_name: The name of the flow log.
...
@pulumi.type_token("azure-native_network_v20230201:network:FlowLog")
class FlowLog(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 storage_id: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
    ...
    @property
    @pulumi.getter(name="storageId")
    def storage_id(self) -> pulumi.Output[builtins.str]:
        """
        ID of the storage account which is used to store the flow log.
        """
        return pulumi.get(self, "storage_id")
    ...
    def target_resource_guid(self) -> pulumi.Output[builtins.str]:
        """
