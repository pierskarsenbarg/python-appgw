...
class HubVirtualNetworkConnectionArgs:
    def __init__(__self__, *,
                 ...
                 allow_hub_to_remote_vnet_transit: Optional[pulumi.Input[builtins.bool]] = None,
                 allow_remote_vnet_to_use_hub_vnet_gateways: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: The resource group name of the HubVirtualNetworkConnection.
        :param pulumi.Input[builtins.str] virtual_hub_name: The name of the VirtualHub.
        :param pulumi.Input[builtins.bool] allow_hub_to_remote_vnet_transit: Deprecated: VirtualHub to RemoteVnet transit to enabled or not.
        :param pulumi.Input[builtins.bool] allow_remote_vnet_to_use_hub_vnet_gateways: Deprecated: Allow RemoteVnet to use Virtual Hub's gateways.
        :param pulumi.Input[builtins.str] connection_name: The name of the HubVirtualNetworkConnection.
    ...
    def allow_hub_to_remote_vnet_transit(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def allow_hub_to_remote_vnet_transit(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "allow_hub_to_remote_vnet_transit", value)

    @property
    @pulumi.getter(name="allowRemoteVnetToUseHubVnetGateways")
    def allow_remote_vnet_to_use_hub_vnet_gateways(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def allow_remote_vnet_to_use_hub_vnet_gateways(self, value: Optional[pulumi.Input[builtins.bool]]):
...
@pulumi.type_token("azure-native_network_v20230201:network:HubVirtualNetworkConnection")
class HubVirtualNetworkConnection(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="allowHubToRemoteVnetTransit")
    def allow_hub_to_remote_vnet_transit(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Deprecated: VirtualHub to RemoteVnet transit to enabled or not.
        """
        return pulumi.get(self, "allow_hub_to_remote_vnet_transit")
    ...
    @property
    @pulumi.getter(name="allowRemoteVnetToUseHubVnetGateways")
    def allow_remote_vnet_to_use_hub_vnet_gateways(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Deprecated: Allow RemoteVnet to use Virtual Hub's gateways.
        """
        return pulumi.get(self, "allow_remote_vnet_to_use_hub_vnet_gateways")
