...
class DdosProtectionPlanArgs:
    def __init__(__self__, *,
                 ...
                 ddos_protection_plan_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] ddos_protection_plan_name: The name of the DDoS protection plan.
    ...
    def ddos_protection_plan_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def ddos_protection_plan_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("azure-native_network_v20230201:network:DdosProtectionPlan")
