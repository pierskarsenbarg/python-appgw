...
class GetBastionHostResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, disable_copy_paste=None, dns_name=None, enable_file_copy=None, enable_ip_connect=None, enable_kerberos=None, enable_shareable_link=None, enable_tunneling=None, etag=None, id=None, ip_configurations=None, location=None, name=None, provisioning_state=None, scale_units=None, sku=None, tags=None, type=None):
...
def get_bastion_host(bastion_host_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getBastionHost', __args__, opts=opts, typ=GetBastionHostResult, package_ref=_utilities.get_package()).value
...
def get_bastion_host_output(bastion_host_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getBastionHost', __args__, opts=opts, typ=GetBastionHostResult, package_ref=_utilities.get_package())
