...
def get_inbound_nat_rule(expand: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getInboundNatRule', __args__, opts=opts, typ=GetInboundNatRuleResult, package_ref=_utilities.get_package()).value
...
def get_inbound_nat_rule_output(expand: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getInboundNatRule', __args__, opts=opts, typ=GetInboundNatRuleResult, package_ref=_utilities.get_package())
