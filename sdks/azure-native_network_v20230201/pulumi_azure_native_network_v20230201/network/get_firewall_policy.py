...
def get_firewall_policy(expand: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getFirewallPolicy', __args__, opts=opts, typ=GetFirewallPolicyResult, package_ref=_utilities.get_package()).value
...
def get_firewall_policy_output(expand: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getFirewallPolicy', __args__, opts=opts, typ=GetFirewallPolicyResult, package_ref=_utilities.get_package())
