...
class GetVirtualHubResult:
    ...
    def hub_routing_preference(self) -> Optional[builtins.str]:
        """
    ...
    def preferred_routing_gateway(self) -> Optional[builtins.str]:
        """
...
def get_virtual_hub(resource_group_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native_network_v20230201:network:getVirtualHub', __args__, opts=opts, typ=GetVirtualHubResult, package_ref=_utilities.get_package()).value
...
def get_virtual_hub_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native_network_v20230201:network:getVirtualHub', __args__, opts=opts, typ=GetVirtualHubResult, package_ref=_utilities.get_package())
